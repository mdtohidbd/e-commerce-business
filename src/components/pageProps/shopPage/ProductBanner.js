      ...
      <div className="flex items-center gap-2 md:gap-6 mt-4 md:mt-0">
        ...
        <div className="flex items-center gap-2 text-[#767676] relative">
          ...
          <select
            ...
            id="countries"
            className="w-16 md:w-20 border-[1px] border-gray-400 py-1 px-4 cursor-pointer text-primeColor text-base block dark:placeholder-gray-400 appearance-none focus-within:outline-none focus-visible:border-primeColor"
          >
